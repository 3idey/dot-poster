            ...
            <div class="flex items-center justify-between mb-6">
                ...
                <div class="flex items-center space-x-2">
                    <div class="flex text-yellow-400">
                        @for ($i = 1; $i <= 5; $i++)
                            <svg class="w-5 h-5 {{ $i <= round($product->average_rating) ? 'fill-current' : 'text-gray-600 dark:text-gray-500' }}"
                                viewBox="0 0 20 20">
                                <path
                ...
                @foreach ($product->category->products->where('id', '!=', $product->id)->take(4) as $relatedProduct)
                    <div
                        ...
                        <a href="{{ route('products.show', $relatedProduct->id) }}" class="block">
                            ...
                            <h3 class="text-white dark:text-gray-100 font-medium mb-2">{{ $relatedProduct->name }}
                            </h3>
