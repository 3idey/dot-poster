                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <label class="relative cursor-pointer payment-method-label" data-payment="cash">
                                <input type="radio" name="payment_method_radio" value="cash" class="sr-only"
                                    checked>
                                <div
                                    class="bg-white border-2 border-emerald-500 rounded-xl p-6 transition-all hover:border-emerald-600 payment-method-card">
                                    <div class="flex items-center space-x-3">
                                        <div
                                            class="w-5 h-5 rounded-full border-2 border-emerald-500 bg-emerald-500 relative payment-radio">
                                            <div
                                                class="absolute inset-1 rounded-full bg-white scale-100 transition-transform">
                                            </div>
                                        </div>
                                        <div>
                            ...
                            <label class="relative cursor-pointer payment-method-label" data-payment="stripe">
                                ...
                                <div
                                    class="bg-white border-2 border-gray-200 rounded-xl p-6 transition-all hover:border-gray-300 payment-method-card">
                                    <div class="flex items-center space-x-3">
                                        <div
                                            class="w-5 h-5 rounded-full border-2 border-gray-400 relative payment-radio">
                                            <div
                                                class="absolute inset-1 rounded-full bg-white scale-0 transition-transform">
                                            </div>
                                        </div>
                                        <div>
                            ...
                            <div class="mt-6">
                                ...
                                <div class="space-y-3">
                                    @foreach ($savedPaymentMethods as $savedMethod)
                                        <label class="relative cursor-pointer payment-method-label" data-payment="saved"
                                            data-saved-id="{{ $savedMethod->id }}">
                                            <input type="radio" name="payment_method_radio" value="saved"
                                                class="sr-only">
                                            <div
                                                class="bg-white border-2 border-gray-200 rounded-xl p-4 transition-all hover:border-gray-300 payment-method-card">
                                                <div class="flex items-center justify-between">
                                                    <div class="flex items-center space-x-3">
                                                        ...
                                                        <div class="flex items-center space-x-3">
                                                            <div
                                                                class="w-10 h-6 bg-gradient-to-r {{ $savedMethod->brand === 'visa' ? 'from-blue-600 to-blue-700' : ($savedMethod->brand === 'mastercard' ? 'from-red-500 to-orange-500' : 'from-gray-600 to-gray-700') }} rounded flex items-center justify-center">
                                                                <span
                                                                    class="text-white text-xs font-bold">{{ strtoupper(substr($savedMethod->brand, 0, 4)) }}</span>
                                                            </div>
                                                            <div>
                                                                <div class="font-semibold text-gray-900">
                                                                    {{ $savedMethod->display_name }}</div>
                                                                <div class="text-sm text-gray-600">Expires
                                                                    {{ $savedMethod->exp_month }}/{{ $savedMethod->exp_year }}
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    @if ($savedMethod->is_default)
                                                        <span
                                                            class="px-2 py-1 bg-emerald-500/20 text-emerald-400 rounded-full text-xs font-semibold">Default</span>
                                                    @endif
                                                </div>
                                            </div>
                                        </label>
            ...
            <div class="relative z-10">
                <div class="flex items-center justify-between mb-6">
                    <div class="flex items-center">
                        <div
                            class="w-12 h-12 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-xl flex items-center justify-center mr-4 shadow-lg">
                    ...
                    <div class="flex space-x-3 opacity-80">
                        <div
                            class="w-10 h-6 bg-gradient-to-r from-blue-600 to-blue-700 rounded flex items-center justify-center">
                            <span class="text-white text-xs font-bold">VISA</span>
                        </div>
                        <div
                            class="w-10 h-6 bg-gradient-to-r from-red-500 to-orange-500 rounded flex items-center justify-center">
                            <span class="text-white text-xs font-bold">MC</span>
                        </div>
                        <div
                            class="w-10 h-6 bg-gradient-to-r from-blue-800 to-blue-900 rounded flex items-center justify-center">
                ...
                <div
                    class="bg-gray-50 rounded-xl p-5 border border-gray-200 focus-within:ring-2 focus-within:ring-emerald-500/50 focus-within:border-emerald-400 transition-all duration-300">
                    <div id="card-element" class="min-h-[45px] text-gray-800">
                        <!-- Stripe Elements will create form elements here -->
                    </div>
                </div>

                <div id="card-errors" role="alert" class="text-red-500 text-sm mt-4 min-h-[20px] font-medium">
                </div>
                ...
                <div class="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
                    ...
                    <div class="mt-3 hidden" id="payment-nickname-section">
                        <input type="text" name="payment_nickname"
                            placeholder="Give this card a nickname (optional)"
