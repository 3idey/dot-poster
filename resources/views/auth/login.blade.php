    ...
    <div class="max-w-md mx-auto mt-20">
        <div class="bg-gray-800 border border-gray-700 rounded-2xl shadow-2xl p-8">
            ...
            <div class="mt-6">
                ...
                <div class="mt-6">
                    <a href="{{ route('google.redirect') }}" class="w-full inline-flex justify-center items-center px-4 py-3 border border-gray-600 rounded-lg shadow-sm bg-white text-gray-700 text-sm font-medium hover:bg-gray-50 transition-colors">
