            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <form action="{{ route('vendor.products.update', $product->id) }}" method="POST"
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-6">
                            <div>
                                <label for="name" class="block text-sm font-semibold text-gray-700 mb-2">Product Name
                                    *</label>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <label for="category_id" class="block text-sm font-semibold text-gray-700 mb-2">Category
                                        *</label>
                                ...
                                <div>
                                    ...
                                    <select name="status" id="status"
                                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all @error('status') border-red-500 @enderror"
                                        required>
                                        <option value="1"
                            ...
                            <div>
                                ...
                                @if ($product->image)
                                    <div id="current-image" class="mb-4">
                                        ...
                                        <button type="button" onclick="changeImage()" id="change-image-btn"
                                            class="mt-2 text-sm text-blue-600 hover:text-blue-800">Change image</button>
                                    </div>
                                @endif
                                ...
                                <div id="image-preview" class="hidden mt-4">
                                    ...
                                    <button type="button" onclick="removeImage()" class="mt-2 text-red-600 text-sm hover:underline">Remove new image</button>
                                </div>
