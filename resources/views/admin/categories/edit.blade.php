...
@section('content')
    <div class="max-w-2xl mx-auto bg-white shadow rounded-lg p-6">
        ...
        <form method="POST" action="{{ route('admin.categories.update', $category) }}">
            ...
            {{-- Submit --}}
            <button type="submit" class="bg-gradient-to-r from-emerald-600 to-emerald-700 text-white px-4 py-2 rounded-xl hover:from-emerald-700 hover:to-emerald-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105">Update Category</button>
